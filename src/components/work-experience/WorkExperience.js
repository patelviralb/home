    ...
    const onToggleButtonClick = companyName => {
        switch (companyName) {
            case 'QB':
                ...
                break;
            case 'PROLIFICS':
                toggleStatus(prolificsWorkExperience,
                    setProlificsWorkExperience);
                break;
            case 'INFOSYS_TA':
                toggleStatus(infosysTaWorkExperience,
                    setInfosysTaWorkExperience);
                break;
            case 'INFOSYS_SSE':
                toggleStatus(infosysSseWorkExperience,
                    setInfosysSseWorkExperience);
                break;
            case 'INFOSYS_SE':
                toggleStatus(infosysSeWorkExperience,
                    setInfosysSeWorkExperience);
                break;
            default:
                break;
        }
                        ...
                        <section className="vp-work-experience-bar">
                            <div className="container-fluid">
                                <div className="vp-work-experience-item">
                                    <div
                                        className="vp-work-experience-item-bullet"/>
                                    <div className="vp-work-experience-content">
                                        <h4 className="mt-5 pt-4">Software
                                            Engineer Co-op</h4>
                                        <QuickBase/>
                                        {/*<h4>Quick Base</h4>*/}
                                        <div
                                            className="vp-work-experience-duration">
                                            June 2020 - Present
                                        </div>
                                        <blockquote
                                            className="vp-work-experience-description">
                                            <button
                                            ...
                                            <ul className="collapse"
                                                ...
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    ...
                                                    designed using React, Redux
                                                    which
                                                    uses backend API which is
                                                    written in C++
                                                </li>
                                            </ul>
                                        </blockquote>
                                    ...
                                    <div className="vp-work-experience-content">
                                        ...
                                        <blockquote
                                            ...
                                            >
                                                ...
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    Created a unique solution to
                                                    track Medicare claims
                                                    using ITX/IBM WTX and MySQL
                                                </li>
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    Worked on JSON, XML, CSV and
                                                    ANSI X12 files
                                                </li>
                                            </ul>
                                        </blockquote>
                                ...
                                <div className="vp-work-experience-item">
                                    <div
                                        className="vp-work-experience-item-bullet"/>
                                    <div className="vp-work-experience-content">
                                        <h4 className="mt-5 pt-4">Technology
                                            Analyst</h4>
                                        <Infosys/>
                                        ...
                                        <blockquote
                                            ...
                                            >
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    ...
                                                    gathering and effort
                                                    estimations
                                                    for file processing and
                                                    transformation (to and from
                                                    ANSI X12, CSV, Fixed length,
                                                    XML) using IBM WTX/ITX
                                                    based on requirement
                                                    complexities
                                                </li>
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    Implemented a multi-file
                                                    format project requirement
                                                    using IBM WTX and shell
                                                    scripting, which resulted in
                                                    new business acquisition for
                                                    the client resulting in a
                                                    30% increase in billing for
                                                    the company from the
                                                    client for the full project
                                                    design and implementation
                                                </li>
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    Provided release support
                                                    while production deployment
                                ...
                                <div className="vp-work-experience-item">
                                    ...
                                    <div className="vp-work-experience-content">
                                        ...
                                        <blockquote
                                            ...
                                            >
                                                <li className="text-justify vp-work-experience-description-bullets">
                                                    Developed custom validations
                                                    for healthcare batch
                                                    transactions like 834, 835,
                                                    837, etc. and real-time
                                                    transactions like 270, 271,
                                                    276, 277, 278, etc. using
                                                    C and Shell Scripting along
                                                    with custom maps
                                                    development for various
                                                    vendors using IBM WTX to
                                                    convert ANSI X12, CSV files
                                                    to Fixed Length files and
                                                    vice versa
                                                </li>
                                            </ul>
                                        </blockquote>
